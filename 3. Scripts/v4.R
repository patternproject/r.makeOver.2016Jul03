...
g.2 <-
  g.2 + geom_label(
    ...
    aes(x = 2.5, y = 1, label = "Leaders on all three scales are concentrated on lower left. \nQuantiles of Economic Index on X-Axis, Education on Y-Axis and \nOverall Rank is color coded in RED. Exact opposite for Discoverers, \nor those on lowest end of scale - color coded in BLUE\n")
  )
...
g.2 <- g.2 + labs(title="Does Education power Economic Outcome ?",
                subtitle="Quantiles of Education Rank Index VERSUS Quantiles of Economic Rank Index ",
